...
export default function Hero({ onStart }: HeroProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50 flex flex-col items-center justify-center px-4 py-16">
      {/* Badge */}
      <motion.div
      ...
      <motion.h1
        ...
        className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 text-center leading-tight mb-4 max-w-3xl"
      >
      ...
      <motion.button
        ...
        onClick={onStart}
        className="px-8 py-4 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold text-lg rounded-2xl shadow-lg shadow-indigo-200 hover:shadow-indigo-300 transition-all duration-200 flex items-center gap-2 mb-14"
      >
